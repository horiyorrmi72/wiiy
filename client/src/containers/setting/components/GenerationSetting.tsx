    ...
    <Flex className="profile-form">
      ...
      >
        <Typography.Paragraph>
          <pre>
            Please estimate how many story points it will take your team to
            deliver this sample task below. It is used for task estimation
            during development plan generation.
          </pre>
        </Typography.Paragraph>

        <Form.Item label="Sample Task Description">
          <MultilineText text={SampleTask} />
        </Form.Item>
        <Form.Item
          label="Sample Task Story Point"
          name="sampleTaskStoryPoint"
          tooltip="Baseline story point for the sample task."
          rules={[REQUIRED]}
        >
          <InputNumber
            placeholder="Enter the estimated story point of your team for the sample task below"
            style={{ width: '100%' }}
          />
        </Form.Item>
        <Form.Item
          label="Document Generate Language"
          name="documentGenerateLang"
          tooltip="Select the language of your team for the documents generate"
          rules={[REQUIRED]}
          hidden={true}
        >
