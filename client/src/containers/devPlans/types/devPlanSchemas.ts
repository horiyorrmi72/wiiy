// Copied from /server/lib/devPlanSchemas.ts
import { IssueType, WorkPlanType } from '@prisma/client';
import { z } from 'zod';

export const TaskSchema = z.object({
  key: z.string().describe('Key of the task'),
  ...
  sprintKey: z.string().optional().describe('Key of the sprint'),
});
...
export const StorySchema = z.object({
  key: z.string().describe('Key of the story'),
  name: z.string().describe('Name of the user story'),
  description: z.string().optional().describe('Description of the user story'),
  type: z
    .string()
...
export const EpicSchema = z.object({
  key: z.string().describe('Key of the epic'),
...
const MilestoneEpicSchema = EpicSchema.omit({ children: true }).extend({
  storyPoint: z
    .number()
...
export const SprintSchema = z
  .object({
    ...
    description: z.string().optional().describe('Description of the sprint'),
