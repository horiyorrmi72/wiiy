...
type DevPlanTeamInputProps = Omit<
  SelectUserProps,
  'multiple' | 'secondaryInformation' | 'value' | 'onChange'
> &
  Readonly<{
          ...
          <Flex vertical align="flex-start">
            ...
            >
              ...
              {isInvitingTeamMemberLocked && (
                <Tooltip title="Max team count reached. Please upgrade your plan.">
      ...
      >
        {selectedNames?.length ? (
          ...
          <div className="text-ellipsis placeholder">
            Invite team or Add virtual teammates
          </div>
        )}
      </div>
    </Popover>
