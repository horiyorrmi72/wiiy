...
export default function ChatRecords({
  ...
  useEffect(() => {
    if (chatContainerBottomDiv && chatContainerBottomDiv.current) {
  ...
  return (
    ...
    >
          ...
          >
            ...
            >
              ...
              >
                ...
                <div onClick={() => copyText(record)}>Copy</div>
                <EditOutlined style={docIconStyle} />{' '}
                <div onClick={() => editText(record)}>Edit</div>
                <FileTextOutlined style={docIconStyle} />{' '}
                <div onClick={() => generateDoc(record)}>Generate Doc</div>
              </Flex>
            </Flex>
          </Flex>
        )
      ...
      {!records?.length && isLoaded && (
        ...
        >
          {introMsg}
          &nbsp; Please feel free to ask me below.
        </Flex>
      )}
      {!isLoaded && (
        <Flex
